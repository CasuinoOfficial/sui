                ...
                Box::pin(async move {
                    ...
                    if request_ref.include_input_objects || request_ref.include_output_objects {
                        ...
                        client
                            ...
                            .monitor_cancellation()
                            .instrument(trace_span!("handle_certificate_v3", cancelled = false, authority =? concise_name))
                            .await
                    } else {
                        client
                            .handle_certificate_v2(request_ref.certificate, client_addr)
                            .monitor_cancellation()
                            .instrument(trace_span!("handle_certificate_v2", cancelled = false, authority =? concise_name))
                            .await
